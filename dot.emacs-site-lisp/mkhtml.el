...
;; Version: 20.1
;; Last-Updated: Fri Dec 31 09:46:42 2004
;;           By: dradams
;;     Update #: 2272
...
;;
;; 
;;  Library `mkhtml' requires these libraries:
;;
;;    `avoid', `cl', `custom', `dired', `easymenu', `fit-frame',
;;    `frame-cmds', `frame-fns', `icomplete', `icomplete+', `info',
;;    `info+', `mkhtml-htmlize', `setup-info', `strings', `thingatpt',
;;    `thingatpt+'.
;;
;;
;;
