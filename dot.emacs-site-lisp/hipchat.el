...
;; from https://gist.github.com/egh/5f46b5d6d2061f305b46

;; Bdc34 notes:
;; Install packages s, request, seq, jabber
;; Customize Jabber Account List
;; JID from https://cul-it.hipchat.com/account/xmpp
;; password
;; network server: chat.hipchat.com
;; port 5223
;; connection type Legacy SSL/TLS

;; To connect do jabber-connect then the JID for hipcat

;; The prefix is C-x C-j
;; C-x C-j C-r is roster
;; C-x C-j C-l cycles through rooms with unread messages
;; 
